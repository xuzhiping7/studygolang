...
func init() {
	...
	Map_PropsData[1] = model.NewWechatProp(1, "止血草", "使用能够回复生命值20点。")
	Map_PropsData[2] = model.NewWechatProp(2, "风信子", "一级素材，可以卖给商人。")
	Map_PropsData[3] = model.NewWechatProp(3, "结实黄泥", "一级素材，可以卖给商人。")
