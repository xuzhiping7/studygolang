...
func init() {
	...
	Map_MapData[1] = model.NewWechatMap(1, "林风村", "林风角的一个小村落，常年大风，在海角之上临海而拔起，空气潮湿。春秋之季常遭海怪袭击。\n\n'买'：购买物品\n'卖'：出售物品", 0, []int{}, []int{}, []int{2, 3}, []int{1, 4, 5})
	Map_MapData[2] = model.NewWechatMap(2, "林风南海岸", "海怪的聚集地，是初出勇者作为'修炼'的好地方。\n\n'修炼'：在此地修炼\n", 0, []int{0, 1}, []int{50, 50}, []int{1}, []int{})
	Map_MapData[3] = model.NewWechatMap(3, "流放平原", "多年来林城帝国流放重犯之地，妖魂遍野，也有不少勇士在此扎根修炼，但有去无回的传闻实在太多了。\n\n'修炼'：在此地修炼\n", 5, []int{2, 3}, []int{50, 50}, []int{1}, []int{})
	Map_MapData[4] = model.NewWechatMap(4, "无名村", "无从属国家地区的村落，由浪人自发建立而起，环境十分恶劣。目前仅能提供简单的补给。\n\n'买'：购买物品\n'卖'：出售物品", 5, []int{}, []int{}, []int{2, 3}, []int{1, 4, 5, 6})
	Map_MapData[5] = model.NewWechatMap(5, "临界关", "鲜有人知临界关的后边有什么，临界关迷雾重重，越往深处越无法识别方向。传说在临界关修炼获得‘苍茫之境挑战书’，顺利挑战成功则能顺利到达苍茫之境。这里妖物强大，一不留神，可能将会惨绝人寰。 \n\n'修炼'：在此地修炼\n", 10, []int{4, 5, 6}, []int{50, 45, 5}, []int{1}, []int{})
